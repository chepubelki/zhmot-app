      ...
      <p>
        <label>
          <input
            type="checkbox"
            v-model="agree"
            :class="{ invalid: v$.agree.$dirty && v$.agree.required.$invalid }"
          />
          <span>С правилами согласен</span>
        </label>
        <small
          class="helper-text invalid"
          v-if="v$.agree.$dirty && v$.agree.required.$invalid"
        >
...
export default {
  ...
  validations: {
    ...
    agree: {
      required: helpers.withMessage("Согласие с правилами обязательно", required),
    },
  },
